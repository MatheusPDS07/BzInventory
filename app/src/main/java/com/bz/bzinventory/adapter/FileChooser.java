    ...
    private void refresh(File path) {
        ...
        if (path.exists()) {
            ...
            if (path.getParentFile() == null) {
                fileList = new String[Objects.requireNonNull(dirs).length + Objects.requireNonNull(files).length];
            } else {
                fileList = new String[Objects.requireNonNull(dirs).length + Objects.requireNonNull(files).length + 1];
